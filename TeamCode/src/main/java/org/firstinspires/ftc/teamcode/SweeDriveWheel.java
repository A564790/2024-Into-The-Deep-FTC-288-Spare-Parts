...
class SweeDriveWheel {
    ...
    public SweeDriveWheel(org.firstinspires.ftc.robotcore.external.Telemetry telemetry, String name, DcMotor driveMotor, CRServo angleServo, AnalogInput angleSensor) {
        Telemetry = telemetry;
        Name = name;
